    ...
    public static class SetOperations
    {
        ...
        public static IEnumerable<char> UnionOfQueryResults()
        {
            ...
            return products
                ...
                .Union(customers.Select(c => c.CompanyName.First()));
        }
        ...
        public static IEnumerable<int> Intersect()
        {
            ...
            return numbersA.Intersect(numbersB).Distinct();
        }
        ...
        public static IEnumerable<char> IntersectQueryResults()
        {
            ...
            return products
                .Select (p => p.ProductName.First())
                .Intersect(customers.Select(c => c.CompanyName.First()));
        }
        ...
        public static IEnumerable<char> DifferenceOfQueries()
        {
            ...
            return products
                .Select(p => p.ProductName.First())
                .Except(customers.Select(c => c.CompanyName.First()));
        }
    }
}